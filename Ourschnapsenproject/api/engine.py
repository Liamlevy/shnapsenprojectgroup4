...
def play(
    ...
    # how to access start state?

    if player1.name == 'mybot':
        pr('{} is cheating!'.format(player1), verbose)
        player1.cheat(state, 1, "P1H")
    elif player2.name == 'mybot':
        pr('{} is cheating!'.format(player2), verbose)
        player2.cheat(state, 2, "P2H")
####the code above executes the cheating functions for the players if the cheating is activated
    # The game loop
